...
write.csv(value, file = paste0("result_small_N/val_n", n,"_index", index,"_case",case,".csv"))
write.csv(pcid, file = paste0("result_small_N/pcid_n", n,"_index", index,"_case",case,".csv"))
