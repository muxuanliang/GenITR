...
write.csv(value, file = paste0("result_change_setting_cor/val_delta", delta,"_n", n,"_N", N,"_index", index,"_case",case,".csv"))
write.csv(pcid, file = paste0("result_change_setting_cor/pcid_delta", delta,"_n", n,"_N", N,"_index", index,"_case",case,".csv"))
write.csv(est, file = paste0("result_change_setting_cor/est_delta", delta,"_n", n,"_N", N,"_index", index,"_case",case,".csv"))
write.csv(infer, file = paste0("result_change_setting_cor/infer_delta", delta,"_n", n,"_N", N,"_index", index,"_case",case,".csv"))
